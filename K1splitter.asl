//SW: KotOR Autosplitter - Alpha Release 3 (August 4th 2020)
//Full Configuration
...
{
	vars.reinit = false;
	return (current.area == "END_M01AA" && current.tickcount > 0 && current.tickcount < 30);
}
split
{
	...
	if (current.area != old.area)
	{
		...
		switch (checkarea)
		{
			...
			if (settings["end_1"] == true)
			{
				...
				{
					return true;
				} else if (settings["end_1_1"] == false && vars.startedEnd1 == false)
				{
			...
			if (settings["end_2"] == true)
			{
				...
				{
					return true;
				} else if (settings["end_2_1"] == false && vars.startedEnd2 == false)
				{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			if (settings["tar_1"] == true)
			{
				...
				{
					return true;
				} else if (settings["tar_1_1"] == false && vars.startedTar1 == false)
				{
			...
			if (settings["tar_2"] == true)
			{
				...
				{
					return true;
				} else if (settings["tar_2_1"] == false && vars.startedTar2 == false)
				{
			...
			if (settings["tar_3"] == true)
			{
				...
				{
					return true;
				} else if (settings["tar_3_1"] == false && vars.startedTar3 == false)
				{
			...
			if (settings["tar_4"] == true)
			{
				...
				{
					return true;
				} else if (settings["tar_4_1"] == false && vars.startedTar4 == false)
				{
			...
			if (settings["tar_5"] == true)
			{
				...
				{
					return true;
				} else if (settings["tar_5_1"] == false && vars.startedTar5 == false)
				{
			...
			if (settings["tar_6"] == true)
			{
				...
				{
					return true;
				} else if (settings["tar_6_1"] == false && vars.startedTar6 == false)
				{
			...
			if (settings["tar_7"] == true)
			{
				...
				{
					return true;
				} else if (settings["tar_7_1"] == false && vars.startedTar7 == false)
				{
			...
			if (settings["tar_8"] == true)
			{
				...
				{
					return true;
				} else if (settings["tar_8_1"] == false && vars.startedTar8 == false)
				{
			...
			if (settings["tar_9"] == true)
			{
				...
				{
					return true;
				} else if (settings["tar_9_1"] == false && vars.startedTar9 == false)
				{
			...
			if (settings["tar_10"] == true)
			{
				...
				{
					return true;
				} else if (settings["tar_10_1"] == false && vars.startedTar10 == false)
				{
			...
			if (settings["tar_11"] == true)
			{
				...
				{
					return true;
				} else if (settings["tar_11_1"] == false && vars.startedTar11 == false)
				{
			...
			if (settings["tar_12"] == true)
			{
				...
				{
					return true;
				} else if (settings["tar_12_1"] == false && vars.startedTar12 == false)
				{
			...
			if (settings["tar_13"] == true)
			{
				...
				{
					return true;
				} else if (settings["tar_13_1"] == false && vars.startedTar13 == false)
				{
			...
			if (settings["tar_14"] == true)
			{
				...
				{
					return true;
				} else if (settings["tar_14_1"] == false && vars.startedTar14 == false)
				{
			...
			if (settings["tar_15"] == true)
			{
				...
				{
					return true;
				} else if (settings["tar_15_1"] == false && vars.startedTar15 == false)
				{
			...
			if (settings["tar_16"] == true)
			{
				...
				{
					return true;
				} else if (settings["tar_16_1"] == false && vars.startedTar16 == false)
				{
			...
			if (settings["tar_17"] == true)
			{
				...
				{
					return true;
				} else if (settings["tar_17_1"] == false && vars.startedTar17 == false)
				{
			...
			if (settings["tar_18"] == true)
			{
				...
				{
					return true;
				} else if (settings["tar_18_1"] == false && vars.startedTar18 == false)
				{
			...
			if (settings["tar_19"] == true)
			{
				...
				{
					return true;
				} else if (settings["tar_19_1"] == false && vars.startedTar19 == false)
				{
			...
			if (settings["tar_20"] == true)
			{
				...
				{
					return true;
				} else if (settings["tar_20_1"] == false && vars.startedTar20 == false)
				{
			...
			if (settings["tar_21"] == true)
			{
				...
				{
					return true;
				} else if (settings["tar_21_1"] == false && vars.startedTar21 == false)
				{
			...
			if (settings["tar_22"] == true)
			{
				...
				{
					return true;
				} else if (settings["tar_22_1"] == false && vars.startedTar22 == false)
				{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			if (settings["dan_1"] == true)
			{
				...
				{
					return true;
				} else if (settings["dan_1_1"] == false && vars.startedDan1 == false)
				{
			...
			if (settings["dan_2"] == true)
			{
				...
				{
					return true;
				} else if (settings["dan_2_1"] == false && vars.startedDan2 == false)
				{
			...
			if (settings["dan_3"] == true)
			{
				...
				{
					return true;
				} else if (settings["dan_3_1"] == false && vars.startedDan3 == false)
				{
			...
			if (settings["dan_4"] == true)
			{
				...
				{
					return true;
				} else if (settings["dan_4_1"] == false && vars.startedDan4 == false)
				{
			...
			if (settings["dan_5"] == true)
			{
				...
				{
					return true;
				} else if (settings["dan_5_1"] == false && vars.startedDan5 == false)
				{
			...
			if (settings["dan_6"] == true)
			{
				...
				{
					return true;
				} else if (settings["dan_6_1"] == false && vars.startedDan6 == false)
				{
			...
			if (settings["dan_7"] == true)
			{
				...
				{
					return true;
				} else if (settings["dan_7_1"] == false && vars.startedDan7 == false)
				{
			...
			if (settings["dan_8"] == true)
			{
				...
				{
					return true;
				} else if (settings["dan_8_1"] == false && vars.startedDan8 == false)
				{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			if (settings["man_1"] == true)
			{
				...
				{
					return true;
				} else if (settings["man_1_1"] == false && vars.startedMan1 == false)
				{
			...
			if (settings["man_2"] == true)
			{
				...
				{
					return true;
				} else if (settings["man_2_1"] == false && vars.startedMan2 == false)
				{
			...
			if (settings["man_3"] == true)
			{
				...
				{
					return true;
				} else if (settings["man_3_1"] == false && vars.startedMan3 == false)
				{
			...
			if (settings["man_4"] == true)
			{
				...
				{
					return true;
				} else if (settings["man_4_1"] == false && vars.startedMan4 == false)
				{
			...
			if (settings["man_5"] == true)
			{
				...
				{
					return true;
				} else if (settings["man_5_1"] == false && vars.startedMan5 == false)
				{
			...
			if (settings["man_6"] == true)
			{
				...
				{
					return true;
				} else if (settings["man_6_1"] == false && vars.startedMan6 == false)
				{
			...
			if (settings["man_7"] == true)
			{
				...
				{
					return true;
				} else if (settings["man_7_1"] == false && vars.startedMan7 == false)
				{
			...
			if (settings["man_8"] == true)
			{
				...
				{
					return true;
				} else if (settings["man_8_1"] == false && vars.startedMan8 == false)
				{
			...
			if (settings["man_9"] == true)
			{
				...
				{
					return true;
				} else if (settings["man_9_1"] == false && vars.startedMan9 == false)
				{
			...
			if (settings["man_10"] == true)
			{
				...
				{
					return true;
				} else if (settings["man_10_1"] == false && vars.startedMan10 == false)
				{
			...
			if (settings["man_11"] == true)
			{
				...
				{
					return true;
				} else if (settings["man_11_1"] == false && vars.startedMan11 == false)
				{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			if (settings["kor_1"] == true)
			{
				...
				{
					return true;
				} else if (settings["kor_1_1"] == false && vars.startedKor1 == false)
				{
			...
			if (settings["kor_2"] == true)
			{
				...
				{
					return true;
				} else if (settings["kor_2_1"] == false && vars.startedKor2 == false)
				{
			...
			if (settings["kor_3"] == true)
			{
				...
				{
					return true;
				} else if (settings["kor_3_1"] == false && vars.startedKor3 == false)
				{
			...
			if (settings["kor_4"] == true)
			{
				...
				{
					return true;
				} else if (settings["kor_4_1"] == false && vars.startedKor4 == false)
				{
			...
			if (settings["kor_5"] == true)
			{
				...
				{
					return true;
				} else if (settings["kor_5_1"] == false && vars.startedKor5 == false)
				{
			...
			if (settings["kor_6"] == true)
			{
				...
				{
					return true;
				} else if (settings["kor_6_1"] == false && vars.startedKor6 == false)
				{
			...
			if (settings["kor_7"] == true)
			{
				...
				{
					return true;
				} else if (settings["kor_7_1"] == false && vars.startedKor7 == false)
				{
			...
			if (settings["kor_8"] == true)
			{
				...
				{
					return true;
				} else if (settings["kor_8_1"] == false && vars.startedKor8 == false)
				{
			...
			if (settings["kor_9"] == true)
			{
				...
				{
					return true;
				} else if (settings["kor_9_1"] == false && vars.startedKor9 == false)
				{
			...
			if (settings["kor_10"] == true)
			{
				...
				{
					return true;
				} else if (settings["kor_10_1"] == false && vars.startedKor10 == false)
				{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			if (settings["kas_1"] == true)
			{
				...
				{
					return true;
				} else if (settings["kas_1_1"] == false && vars.startedKas1 == false)
				{
			...
			if (settings["kas_2"] == true)
			{
				...
				{
					return true;
				} else if (settings["kas_2_1"] == false && vars.startedKas2 == false)
				{
			...
			if (settings["kas_3"] == true)
			{
				...
				{
					return true;
				} else if (settings["kas_3_1"] == false && vars.startedKas3 == false)
				{
			...
			if (settings["kas_4"] == true)
			{
				...
				{
					return true;
				} else if (settings["kas_4_1"] == false && vars.startedKas4 == false)
				{
			...
			if (settings["kas_5"] == true)
			{
				...
				{
					return true;
				} else if (settings["kas_5_1"] == false && vars.startedKas5 == false)
				{
			...
			if (settings["kas_6"] == true)
			{
				...
				{
					return true;
				} else if (settings["kas_6_1"] == false && vars.startedKas6 == false)
				{
			...
			if (settings["kas_7"] == true)
			{
				...
				{
					return true;
				} else if (settings["kas_7_1"] == false && vars.startedKas7 == false)
				{
			...
			if (settings["kas_8"] == true)
			{
				...
				{
					return true;
				} else if (settings["kas_8_1"] == false && vars.startedKas8 == false)
				{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			if (settings["tat_1"] == true)
			{
				...
				{
					return true;
				} else if (settings["tat_1_1"] == false && vars.startedTat1 == false)
				{
			...
			if (settings["tat_2"] == true)
			{
				...
				{
					return true;
				} else if (settings["tat_2_1"] == false && vars.startedTat2 == false)
				{
			...
			if (settings["tat_3"] == true)
			{
				...
				{
					return true;
				} else if (settings["tat_3_1"] == false && vars.startedTat3 == false)
				{
			...
			if (settings["tat_4"] == true)
			{
				...
				{
					return true;
				} else if (settings["tat_4_1"] == false && vars.startedTat4 == false)
				{
			...
			if (settings["tat_5"] == true)
			{
				...
				{
					return true;
				} else if (settings["tat_5_1"] == false && vars.startedTat5 == false)
				{
			...
			if (settings["tat_6"] == true)
			{
				...
				{
					return true;
				} else if (settings["tat_6_1"] == false && vars.startedTat6 == false)
				{
			...
			if (settings["tat_7"] == true)
			{
				...
				{
					return true;
				} else if (settings["tat_7_1"] == false && vars.startedTat7 == false)
				{
			...
			if (settings["tat_8"] == true)
			{
				...
				{
					return true;
				} else if (settings["tat_8_1"] == false && vars.startedTat8 == false)
				{
			...
			if (settings["tat_9"] == true)
			{
				...
				{
					return true;
				} else if (settings["tat_9_1"] == false && vars.startedTat9 == false)
				{
			...
			if (settings["tat_10"] == true)
			{
				...
				{
					return true;
				} else if (settings["tat_10_1"] == false && vars.startedTat10 == false)
				{
			...
			if (settings["tat_11"] == true)
			{
				...
				{
					return true;
				} else if (settings["tat_11_1"] == false && vars.startedTat11 == false)
				{
			...
			if (settings["tat_12"] == true)
			{
				...
				{
					return true;
				} else if (settings["tat_12_1"] == false && vars.startedTat12 == false)
				{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			if (settings["lev_1"] == true)
			{
				...
				{
					return true;
				} else if (settings["lev_1_1"] == false && vars.startedLev1 == false)
				{
			...
			if (settings["lev_2"] == true)
			{
				...
				{
					return true;
				} else if (settings["lev_2_1"] == false && vars.startedLev2 == false)
				{
			...
			if (settings["lev_3"] == true)
			{
				...
				{
					return true;
				} else if (settings["lev_3_1"] == false && vars.startedLev3 == false)
				{
			...
			if (settings["lev_4"] == true)
			{
				...
				{
					return true;
				} else if (settings["lev_4_1"] == false && vars.startedLev4 == false)
				{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			if (settings["leh_1"] == true)
			{
				...
				{
					return true;
				} else if (settings["leh_1_1"] == false && vars.startedUnk1 == false)
				{
			...
			if (settings["leh_2"] == true)
			{
				...
				{
					return true;
				} else if (settings["leh_2_1"] == false && vars.startedUnk2 == false)
				{
			...
			if (settings["leh_3"] == true)
			{
				...
				{
					return true;
				} else if (settings["leh_3_1"] == false && vars.startedUnk3 == false)
				{
			...
			if (settings["leh_4"] == true)
			{
				...
				{
					return true;
				} else if (settings["leh_4_1"] == false && vars.startedUnk4 == false)
				{
			...
			if (settings["leh_5"] == true)
			{
				...
				{
					return true;
				} else if (settings["leh_5_1"] == false && vars.startedUnk5 == false)
				{
			...
			if (settings["leh_6"] == true)
			{
				...
				{
					return true;
				} else if (settings["leh_6_1"] == false && vars.startedUnk6 == false)
				{
			...
			if (settings["leh_7"] == true)
			{
				...
				{
					return true;
				} else if (settings["leh_7_1"] == false && vars.startedUnk7 == false)
				{
			...
			if (settings["leh_8"] == true)
			{
				...
				{
					return true;
				} else if (settings["leh_8_1"] == false && vars.startedUnk8 == false)
				{
			...
			if (settings["leh_9"] == true)
			{
				...
				{
					return true;
				} else if (settings["leh_9_1"] == false && vars.startedUnk9 == false)
				{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			if (settings["sfg_1"] == true)
			{
				...
				{
					return true;
				} else if (settings["sfg_1_1"] == false && vars.startedSfg1 == false)
				{
			...
			if (settings["sfg_2"] == true)
			{
				...
				{
					return true;
				} else if (settings["sfg_2_1"] == false && vars.startedSfg2 == false)
				{
			...
			if (settings["sfg_3"] == true)
			{
				...
				{
					return true;
				} else if (settings["sfg_3_1"] == false && vars.startedSfg3 == false)
				{
			...
			if (settings["sfg_4"] == true)
			{
				...
				{
					return true;
				} else if (settings["sfg_4_1"] == false && vars.startedSfg4 == false)
				{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			if (settings["misc_1"] == true)
			{
				...
				{
					return true;
				} else if (settings["misc_1_1"] == false && vars.startedMisc1 == false)
				{
			...
			if (settings["misc_2"] == true)
			{
				...
				{
					return true;
				} else if (settings["misc_2_1"] == false && vars.startedMisc2 == false)
				{
			...
			if (settings["misc_3"] == true)
			{
				...
				{
					return true;
				} else if (settings["misc_3_1"] == false && vars.startedMisc3 == false)
				{
			...
			if (settings["misc_4"] == true)
			{
				...
				{
					return true;
				} else if (settings["misc_4_1"] == false && vars.startedMisc4 == false)
				{
			...
			if (settings["misc_5"] == true)
			{
				...
				{
					return true;
				} else if (settings["misc_5_1"] == false && vars.startedMisc5 == false)
				{
			...
			if (settings["misc_6"] == true)
			{
				...
				{
					return true;
				} else if (settings["misc_6_1"] == false && vars.startedMisc6 == false)
				{
			...
			if (settings["misc_7"] == true)
			{
				...
				{
					return true;
				} else if (settings["misc_7_1"] == false && vars.startedMisc7 == false)
				{
			...
			if (settings["misc_8"] == true)
			{
				...
				{
					return true;
				} else if (settings["misc_8_1"] == false && vars.startedMisc8 == false)
				{
			...
			if (settings["misc_9"] == true)
			{
				...
				{
					return true;
				} else if (settings["misc_9_1"] == false && vars.startedMisc9 == false)
				{
			...
			if (settings["misc_10"] == true)
			{
				...
				{
					return true;
				} else if (settings["misc_10_1"] == false && vars.startedMisc10 == false)
				{
			...
			if (settings["misc_11"] == true)
			{
				...
				{
					return true;
				} else if (settings["misc_11_1"] == false && vars.startedMisc11 == false)
				{
			...
			if (settings["misc_12"] == true)
			{
				...
				{
					return true;
				} else if (settings["misc_12_1"] == false && vars.startedMisc12 == false)
				{
